 ...
 * @var \Cake\Collection\CollectionInterface|string[] $xmlCriterias
 * @var \Cake\Collection\CollectionInterface|string[] $xmlCriteriaAnswers
 */
?>
<!--**********************************
            Content body start
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?= __('Add Xml Submission Answer') ?></h4>
                            </div>
                            <div class="card-body">
