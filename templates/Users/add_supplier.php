					...
					<div class="row">
						<div class="col-xl-12">
							<fieldset>
								...
								echo $this->Form->control('email', ['required' => true, 'class' => 'form-control', 'id' => 'email','label'=>'email *']);
								echo $this->Form->control('contact', ['type' => 'tel', 'label' => 'Contact *(+123456789)', 'pattern' => "[+][0-9]+", 'required' => true, 'class' => 'form-control', 'id' => 'contact']);
								echo $this->Form->control('photo', ['accept' => "image/*", 'type' => 'file', 'class' => 'form-control', 'id' => 'photo','label' =>'profile Pic']);
								?>
								<div class="col-xl-12">
                                                        <fieldset>
...
<script>
	...
	// 	if (firstName.value == '' || lastName.value == '' || contact.value == '' || photo.value == '' || password.value == '' || c_password == '') {
