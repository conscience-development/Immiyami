                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
												...
												<?php
													...
													echo $this->Form->control('email',['class'=>'form-control','readonly'=>true,'id'=>'email','type'=>'email','label'=>'Email','style'=>'background:#ececec']);
                                                    echo $this->Form->control('photo',['label'=>'Profile Picture (300*300) - ( chosen-file: '.$user->photo.' )','type'=>'file','class'=>'form-control','id'=>'photo',]);
                                                    ?>
													<div class="col-xl-12">
                                                        <fieldset>
													...
													// echo $this->Form->control('c_password',['required'=>true, 'pattern'=>".{6,}",'label'=>'Confirm Password','type'=>'password','required'=>true,'class'=>'form-control']);
													...
													echo $this->Form->control('country_id', ['options' => $countries, 'empty' => true,'class'=>'multi-select wide form-control','label'=>'Country *']);
													echo $this->Form->control('preferred_country_id', ['options' => $preferredCountries, 'empty' => true,'class'=>'multi-select wide form-control','label'=>'Preferred Country *']);
													...
													echo $this->Form->control('role',['type'=>'hidden','value'=>'member','class'=>'form-control']);
