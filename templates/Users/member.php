...
<div class="users index col-12">
	<div class="card">
		<div class="card-header">
			...
			<?= $this->Html->link(__('New Member'), ['action' => 'addMember'], ['class' => 'btn btn-primary float-right']) ?>
		</div>
		<div class="card-body">
...
-->
                    <td><?= substr_replace($user->first_name,"...",15) ?></td>
<!--
                    ...
                    <td class="actions">
						...
						<? if($user->status == '0'){ ?>
							<?= $this->Form->postLink('<i class="fa fa-check">'.__('').'</i>', 
								['action' => 'changestatusmember', $user->id],
