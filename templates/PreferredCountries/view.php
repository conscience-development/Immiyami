                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?= h($preferredCountry->name) ?></h4>
                            </div>
                            <div class="card-body">
                                
                                
                                																																
										<div class="preferredCountries view content">
											<table class="table table-bordered table-responsive-sm">
													...
													<th><?= __('Id') ?></th>
																													<td><?= $this->Number->format($preferredCountry->id) ?></td>
																																												...
																																												<tr>
													<th><?= __('Created') ?></th>
													<td><?= date('Y/m/d H:s', strtotime(h($preferredCountry->created))) ?></td>
												</tr>
																																			</table>
																																																			<div class="related">
												<h4><?= __('Related Users') ?></h4>
												<?php if (!empty($preferredCountry->users)) : ?>
												<div class="table-responsive">
													<table class="table table-bordered table-responsive-sm">
														...
														<?php foreach ($preferredCountry->users as $users) : ?>
														<tr>
																							<td><?= h($users->id) ?></td>
																...
																<?= $this->Form->postLink(__('Delete'), ['controller' => 'Users', 'action' => 'delete', $users->id], ['confirm' => __('Are you sure you want to delete this Preferred Countries ?', $users->id)]) ?>
															</td>
														</tr>
														<?php endforeach; ?>
													</table>
