...
<div class="price-btn">
    <? if(empty($Auth->id)){ ?>
    <a href="/Users/login?type=register&package=free" class="btn btn-inline">
...
<div class="col-md-6 col-lg-4">
    <div class="price-card price-active ">
        ...
        <div class="price-btn">
            <? if(empty($Auth->id)){ ?>
            <a href="/Users/login?type=register&package=gold" class="btn btn-inline">
                <i class="fas fa-sign-in-alt"></i>
                <span>Register Now</span>
            </a>
            <?}else{?>
            <?
                                    if(@$Auth->payments[count($Auth->payments) - 1]->package == 'free' || @$Auth->payments[count($Auth->payments) - 1]->status == '0'){
                                        if($Auth->role == 'member'){
                                            ?>
            <a href="/pages/upgrade?package=gold" class="btn btn-inline">
                <i class="fas fa-sign-in-alt"></i>
...
<div class="col-md-6 col-lg-4 d-none">
    <div class="price-card">
        ...
        <div class="price-btn">
            <? if(empty($Auth->id)){ ?>
            <a href="/Users/login?type=register&package=platinum" class="btn btn-inline">
                <i class="fas fa-sign-in-alt"></i>
                <span>Register Now</span>
            </a>
            <?}else{?>
            ...
            <a href="/pages/upgrade?package=platinum" class="btn btn-inline">
                <i class="fas fa-sign-in-alt"></i>
                <span>Upgrade Now</span>
            </a>
            <?}}?>
...
<div class="row feesib feesibRed justify-content-center">
    <div class="col-md-6 col-lg-4">
