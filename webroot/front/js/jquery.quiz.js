...
(function($){
	...
	$.quiz = $.fn.quiz = function(options)
	{
		...
		var CONTAINER = typeof this == 'object'? this.first(): null,
			...
			// Buttons icons
			PLAY_ICO = ' <i class="fa fa-chevron-right" aria-hidden="true"></i> ',
			// PLAY_ICO = '<i class="fa fa-play" aria-hidden="true"></i>',
			BACKWARD_ICO = ' <i class="fa fa-chevron-left" aria-hidden="true"></i> ',
			// BACKWARD_ICO = '<i class="fa fa-step-backward" aria-hidden="true"></i>',
			FORWARD_ICO = ' <i class="fa fa-chevron-right" aria-hidden="true"></i> ',
		...
		var defaults = {
			...
			questionTpl: '<div class="' + FLEX_CLASS + '">'
                ...
                + '<%if(this.question.help_link){%>'
				+ '<a href="<%this.question.help_link%>" target="_blank"><span class="help-icon">'
			...
			resultsTpl: '<div class="' + FLEX_CLASS + '">'
				...
				+ '</div>'
				+ '</div>',
			// startBtnTpl: '<button id="backBtn-pp" class="quiz_btn"> <i class="fa fa-chevron-left" aria-hidden="true"></i> Previous</button>'
			startBtnTpl: '<button class="' + BTN_CLASS + '">'
				// Button start
				+ '<%this.messages.start%>'
				+ PLAY_ICO
				+ '</button>',
			prevBtnTpl: '<button class="' + BTN_CLASS + ' backbtn">'
				+ BACKWARD_ICO
				// Button previous
				+ '<%this.messages.prev%>'
				+ '</button>',
			nextBtnTpl: '<button class="' + BTN_CLASS + ' nextbtn">'
				// Button next
				+ '<%this.messages.next%>'
				+ FORWARD_ICO
				+ '</button>',
